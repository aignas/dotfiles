...
return lush(function()
    return {
        ...
        SpecialKey   { },
        SpellBad     { bg = strongerbg, sp = red, gui = "undercurl" },
        SpellCap     { bg = strongerbg, sp = red, gui = "undercurl" },
        SpellLocal   { bg = strongerbg, sp = red, gui = "undercurl" },
        SpellRare    { bg = strongerbg, sp = red, gui = "undercurl" },
